...
abstract class CloudRunQalipsis @Inject constructor() : DefaultTask() {
    ...
    fun execute() {
        ...
        val url = if (project.hasProperty("qalipsis.cloud.registry.url")) {
            project.property("qalipsis.cloud.registry.url").toString().toHttpUrl()
        } else {
            DEFAULT_CAMPAIGN_API_ROOT_URL
        }
    ...
    companion object {
        val DEFAULT_CAMPAIGN_API_ROOT_URL = "https://app.qalipsis.io/api/campaigns".toHttpUrl()
    }
